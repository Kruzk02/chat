...
public record HandlerFactory(
    Map<String, Map<String, DataOutputStream>> groups, ChatDao chatDao, UserDao userDao) {
  ...
  public HeaderHandler create(ClientContext context) {
    ...
    var messageHandler = new MessageHandler(username, joinedGroups, groups, chatDao, userDao);
